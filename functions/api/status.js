...
export const SERVICES = [
  {
    // 404.html here is generated by dash.lucafchala.com's gen404Html() and
    // pushed on every PURL save — a regression there has no other check, so
    // a bad slug must come back 404, not a soft-200 (broken router) or 5xx.
  ...
  },
  {
    ...
    checks: (b) => [
      ...
      // Same dash-generated 404.html as lucafchala.com — verify it still renders as 404.
      checkStatusCode('roteamento (404)', b + '/__status_probe_404__', 404),
    ],
  },
  {
