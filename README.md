...
└── functions/
    └── api/
        ...
        ├── painel.js                # GET  /api/painel              — third-party + quotas + history + latency in one call
